...
INSERT INTO Topics(name, description) VALUES ('React', 'A frontend library'), ('Redux', 'A state manager'), ('Node', 'Runtime environment'), ('Express', 'backend library'), ('Testing', 'A really great time!'), ('Databases', 'Watch out for the cockroaches');
